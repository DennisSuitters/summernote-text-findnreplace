    ...
    'findnreplace':function(context) {
      ...
      this.findnreplace = function() {
        ...
        $fnrFindBtn.click(function(e) {
          ...
          var fnrCount   = (fnrCode.match(new RegExp(fnrFind, "g")) || []).length
          if (fnrFind) {
        ...
        $fnrReplaceBtn.click(function(e) {
          ...
          if (fnrFind) {
            ...
            if (fnrReplace) {
              if($note.summernote('createRange').toString()){
                var fnrSelected = $note.summernote('createRange').toString();
                var fnrReplaced = fnrCode.replace(new RegExp(fnrSelected,"gi"),fnrReplace);
                $note.summernote('code',fnrReplaced);
              }else{
