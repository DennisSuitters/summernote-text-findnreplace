...
//      highlight: 'border-bottom: 3px solid #fc0; text-decoration: none;',
  ...
  $.extend($.summernote.plugins, {
    'findnreplace': function (context) {
      ...
      if(interface=='bs4')options.classHidden='d-none';
      ...
      this.initialize = function () {
        var fnrBody =
        '<div id="findnreplaceToolbar" class="note-toolbar-wrapper panel-heading ' + options.findnreplace.classHidden + '">' +
          '<div class="form-group">' +
            ...
            '</div>' +
          '</div>' +
          '<small id="findnreplace-info" class="help-block">&nbsp;</small>' +
        '</div>';
